...
Index of reusable module domains.

- `ai/` — coding agents, LLM CLIs, AI workflow tooling.
...
- `editors/` — editor tooling and editor-focused config modules.
- `utils/` — cross-domain utilities that do not fit another domain.

When creating a new domain, update this index.
